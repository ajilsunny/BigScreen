...
<form action="<?php echo site_url('usercontroller/runningtimeadd');?>" method="post">
  ...
  {
    ?>
    <div class="form-group" id="show<?php echo $i ?>" style="visibility:hidden">
       <label class="col-md-4 control-label" align="right"><?php echo $i ?> Show</label>
       <div class="col-md-8 inputGroupContainer">
          <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-align-justify"></i></span>
            <select name="time<?php echo $i ?>" class="form-control">
...
<?php
  ...
  <input type="submit" value="Add" style="background:#FF8D1B;color:white;padding:3px 50%;border:hidden;border-radius:5px">
  </form>
	</div>
  <?php
