              ...
              <div class="panel-body">
                <div class="row">
                  <div class=" col-md-12 col-xs-12 ">
                    ...
                    <form action="<?php echo site_url('dcontroller/distributor_profile_edit') ?>" method="post">
                    <table class="table table-user-information" style="font-size:23px;">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="color:black">: <?php echo $state ?></td>
                        </tr>
                        <tr>
                          <td style="color:black">District</td>
                          <td style="color:black">: <?php echo $district ?></td>
                        </tr>
                        <tr>
