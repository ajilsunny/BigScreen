                     ...
                     <div class="panel-body">
                       <?php
                         ...
                         echo "<font color='#FF0000'>".$s."</font>";
             					...
             					?>
                       <form id="register-form" role="form" class="form" method="post" action="<?php echo site_url('usercontroller/otpcheck')?>">
                ...
                <div class="text-center">
                  ...
                  <div class="panel-body">
                    <?php
          					...
          					?>
                    <form id="register-form" role="form" class="form" method="post" action="<?php echo site_url('usercontroller/forgotpasswordemailcheck')?>">
