...
<?php
		if(!$theatres)
		{
			echo '<center><h1 style="font-family:Times New Roman, Times, serif;font-size:36px;color:#FF0000" >No Theaters...!!</h1></center>';
		}
		else
		{
		?>
    <div align="right" style="padding-right:12%;padding-bottom:1%">
    <form action="<?php echo site_url('acontroller/searchtheatrelist')?>" method="post">
...
<div align="center" style="margin-top:;font-size:18px;color:#000000;width:100%;height:auto;">
      ...
      $district=$row->dname;
  		...
  		$status=$row->lstatus;
		?>
		<form action="<?php echo site_url('acontroller/blocktheatreaction')?>" method="post" name="userlist">
		<tr>
