          ...
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                <div class="row">
                <form action="<?php echo site_url('dcontroller/distributor_profile_update') ?>" method="post" enctype="multipart/form-data">
                  <div class=" col-md-12 col-xs-12 ">
                    <div class="col-md-12 col-lg-12 " align="center"><img alt="User Pic" src="<?php echo base_url('images/profile/').$profile_pic;?>" class="img-circle img-responsive"> </div>
                      <div class="col-md-12 inputGroupContainer" align=right>
                         <div class="input-group"><input id="profilepic" accept=".png, .jpg, .jpeg,.JPG" name="profilepic"  type="file" style="font-size: 120%; "></div>
                      </div>
                    ...
                    <button type="submit"class="btn btn-primary btn-sm btn-warning" title="Edit this Profile" ><i class="fa fa-upload"></i></button>
                    </span>
                  </form>
                  </div>
                </div>
