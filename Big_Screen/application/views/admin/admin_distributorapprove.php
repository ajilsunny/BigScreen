...
<?php
    ...
    <form action="<?php echo site_url('acontroller/searchdistributor')?>" method="post">
...
<div align="center" style="margin-top:;font-size:18px;color:#000000;width:100%;height:auto;">
    ...
    $district=$row->dname;
		...
		$status=$row->lstatus;
		?>
		<form action="<?php echo site_url('acontroller/approvedistributoraction')?>" method="post" name="userlist">
		<tr>
    ...
    <td>
		<input type="submit" value="Approve" style="background-color:#00FF00">
