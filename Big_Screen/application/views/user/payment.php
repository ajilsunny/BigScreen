        ...
        <div class="col-xs-12 col-md-7">
            ...
            <div class="panel panel-default credit-card-box" style="padding:10px">
                ...
                <div class="panel-body">
                    <form role="form" id="payment-form" method="POST" action="<?php echo site_url('ucontroller/payment') ?>">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                  ...
                                  <div align=right class="col-xs-6">  <label style="font-size:20px">₹<?php echo $totalamount ?></label> </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
