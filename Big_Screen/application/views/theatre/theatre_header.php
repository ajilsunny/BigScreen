				...
				<div style="margin-left:9%" class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav">
							<li><a href="<?php echo site_url('tcontroller/theatrehome');?>">Home</a></li>
							<li class="dropdown">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
									<div class="col-sm-4">
										<li><a href="<?php echo site_url('tcontroller/theatrefilmselection');?>">All Film<div class="listu" align="center"> <font color="#980017"></font></div></a></li>
										<li><a href="<?php echo site_url('tcontroller/theatreacceptfilm');?>">Accepted Films<div class="listu" align="center"> <font color="#980017"> </font></div></a></li>
										<li><a href="<?php echo site_url('tcontroller/theatrebookedfilm');?>">Booked Films<div class="listu" align="center"> <font color="#980017"> </font></div></a></li>
									<div class="clearfix"></div>
									</li>
								</ul>
							</li>
