          ...
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                <div class="row">
                <form action="<?php echo site_url('tcontroller/theatre_profile_update') ?>" method="post" enctype="multipart/form-data">
                  <div class=" col-md-12 col-xs-12 ">
                    <div class="col-md-12 col-lg-12 " align="center"><img alt="User Pic" src="<?php echo base_url('images/profile/').$profile_pic; ?>" class="img-circle img-responsive avatar" height=200px width=200px> </div>
