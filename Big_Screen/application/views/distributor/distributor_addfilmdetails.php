                            ...
                            <div class="col-xs-8 inputGroupContainer">
                              <p id="vfilm" style="color:red;"></P>
                               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-film"></i></span>
                                 <input id="filmName" name="filmName" placeholder="Film Name" class="form-control" type="text" onkeyup="this.value = this.value.toUpperCase();"></div>
                            </div>
                         </div>
                           <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-xs-8 inputGroupContainer">
                              <p id="vcoverpic" style="color:red;"></P>
                                <div class="input-group"><input id="coverpic" name="coverpic" accept=".png, .jpg, .jpeg" Director type="file" style="font-size: 120%"></div>
                            </div>
                         </div>
                            ...
                            <div class="col-xs-8 inputGroupContainer">
                              <p id="vactor0" style="color:red;"></P>
                               <div class="input-group">
                                 ...
                                 <input id="actor0" name="actor0" style="width:85%" placeholder="Actor Name" class="form-control"  type="text">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-xs-8 inputGroupContainer">
                              <p id="vactorpic0" style="color:red;"></P>
                                <div class="input-group"><input id="actorpic0" name="actorpic0" accept=".png, .jpg, .jpeg,.JPG" type="file" style="font-size: 120%"></div>
                            </div>
                         </div>
                            ...
                            <div class="col-xs-8 inputGroupContainer">
                              <p id="vactress0" style="color:red;"></P>
                               <div class="input-group">
                                 ...
                                 <input id="actress0" name="actress0" style="width:85%" placeholder="Actress Name" class="form-control"  type="text">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-xs-8 inputGroupContainer">
                              <p id="vactresspic0" style="color:red;"></P>
                                <div class="input-group"><input id="actresspic0" name="actresspic0" accept=".png, .jpg, .jpeg,.JPG" type="file" style="font-size: 120%"></div>
                            </div>
                         </div>
